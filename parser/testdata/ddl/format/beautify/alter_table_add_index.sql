...
ALTER TABLE test.events_local ON CLUSTER 'default_cluster' ADD INDEX created_at_idx created_at TYPE minmax GRANULARITY 1 SETTINGS alter_sync = 2;
ALTER TABLE test.events_local ON CLUSTER 'default_cluster' ADD INDEX IF NOT EXISTS created_at_idx created_at TYPE minmax GRANULARITY 1 SETTINGS alter_sync = 2;
...
ALTER TABLE test.events_local
ON CLUSTER 'default_cluster'
ADD INDEX created_at_idx created_at TYPE minmax GRANULARITY 1
SETTINGS
  alter_sync=2;
ALTER TABLE test.events_local
ON CLUSTER 'default_cluster'
ADD INDEX IF NOT EXISTS created_at_idx created_at TYPE minmax GRANULARITY 1
SETTINGS
  alter_sync=2;
